window.addEventListener('load', function(){
    ...
    class Game {
        constructor(width, height){
            ...
            this.gameOver = false;
            this.score = 0;
            this.winningScore = 500;// puntuacion ganadora
            this.gameTime = 0;
            this.timeLimit = 90000; //tiempo partida
            this.speed = 2;
            this.speedIncreaseInterval = 10000; // Intervalo de 10 segundos
            this.speedIncreaseAmount = 2; // Cantidad de aumento de velocidad
        ...
        draw(context){
            this.background.draw(context); //dibuja el fondo del juego 
